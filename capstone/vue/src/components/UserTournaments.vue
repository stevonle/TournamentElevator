    ...
    <div v-if="!loading" class="container">
      <div class="row">
        <div
          ...
          :key="tournament.id"
        >
          <div @click="viewTournamentDetails(tournament.id)" class="tournament-card card text-center text-white">
            ...
            <textarea
              ...
              rows="3"
            />
            <router-link v-bind:to="{name: 'EditTournament', params: {id: tournament.id}}"> Edit Tournament </router-link>
          </div>
        </div>
      </div>
    </div>
